...
<body>
    <input type="hidden" id="username" value="<?php echo $UserdataRow[1]?>">
    ...
    <div style="margin-top:2%; margin-left: 2%; margin-right: 2%;">
        <div class="form-group">
            <label>Nombre:</label>
            <input type="text" id="NomCli" class="form-control" value="<?php echo $UserdataRow[2]?>">
        </div>
        <div class="form-group">
            <label>Apellido:</label>
            <input type="text" id="ApeCli" class="form-control" value="<?php echo $UserdataRow[3]?>">
        </div>
        <div class="form-group">
            <label>DNI:</label>
            <input type="text" id="DNICli" class="form-control" value="<?php echo $UserdataRow[4]?>">
        </div>
        <div class="form-group">
            <label>Direccion:</label>
            <input type="text" id="DirCli" class="form-control" value="<?php echo $UserdataRow[5]?>">
        </div>
        <div class="form-group">
            <label>Correo</label>
            <input type="email" id="MailCli" class="form-control" value="<?php echo $UserdataRow[6]?>">
        </div>
        <div class="form-group">
    	    <button class="btn btn-block btn-outline-primary" id="ActData">Actualizar Datos</button>
        </div>
    </div>
    ...
    <script src="../../resources/js/Clie/ActCliente.js"></script>
</body>
